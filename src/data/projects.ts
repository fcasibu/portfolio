export const projects = [
  ...
  },
  {
    ...
    description:
      'Photo Tagging Application. Three maps. Three Characters. Find all three as fast as you can!',
    repo: 'https://github.com/nevz9/photo-tagging-app',
    live: 'https://photo-tagging-app-852b2.web.app/#/',
    image: require('../assets/photo-tagging.png'),
    technologies: [
      require('../assets/react.svg'),
      require('../assets/firebase.svg'),
      require('../assets/jest.svg'),
